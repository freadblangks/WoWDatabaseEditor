...
namespace Avalonia.Controls
{
    ...
    /// </summary>
    public class WrapPanelWithDivider : Panel, INavigableContainer
    {
        /// <summary>
        /// Defines the <see cref="Orientation"/> property.
        /// </summary>
        public static readonly StyledProperty<Orientation> OrientationProperty =
            AvaloniaProperty.Register<WrapPanelWithDivider, Orientation>(nameof(Orientation), defaultValue: Orientation.Horizontal);

        /// <summary>
        /// Defines the <see cref="ItemWidth"/> property.
        /// </summary>
        public static readonly StyledProperty<double> ItemWidthProperty =
            AvaloniaProperty.Register<WrapPanelWithDivider, double>(nameof(ItemWidth), double.NaN);
        ...
        public static bool GetForceNewLine(IControl item) => (bool?)item.GetValue(ForceNewLineProperty) ?? false;

        /// <summary>
        /// Initializes static members of the <see cref="WrapPanelWithDivider"/> class.
        /// </summary>
        static WrapPanelWithDivider()
        {
            AffectsMeasure<WrapPanelWithDivider>(OrientationProperty, ItemWidthProperty, ItemHeightProperty);
        }
        ...
        /// <summary>
        /// Gets or sets the width of all items in the WrapPanelWithDivider.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the height of all items in the WrapPanelWithDivider.
        /// </summary>
        ...
        IInputElement INavigableContainer.GetControl(NavigationDirection direction, IInputElement? from, bool wrap)
        {
            ...
            int index = from == null ? -1 : Children.IndexOf((IControl)from);
